...
```{r fig.margin = TRUE, fig.cap = "Topology of Hopfield networks with 3 neurons.", out.width="140%", cache=TRUE, echo=FALSE}
knitr::include_graphics("./assets/Topology-of-Hopfield-networks-here-with-3-neurons-as-an-example-Linear-transfer.png")
```



```{r fig.margin = TRUE, out.width="110%", cache=TRUE, echo=FALSE, fig.cap = "Moore's law and number of transistors."}
knitr::include_graphics("./assets/1280px-Moore's_Law_Transistor_Count_1971-2018.png")
```
```{marginfigure}
Source: [Number of transistors for microprocessors](https://en.wikipedia.org/wiki/Moore%27s_law#/media/File:Moore's_Law_Transistor_Count_1971-2018.png) at en.wikipedia.org.
\
```
