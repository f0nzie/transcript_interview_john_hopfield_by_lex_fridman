...
```{r NeuralDev, fig.margin = TRUE, out.width="110%", cache=TRUE, echo=FALSE, fig.cap="Neural development starts at the embryo phase. The millions of neurons that the human brain requires for thought is reached by a process of proliferation through cell divisions.",}
...
```{r error_correction, fig.margin = TRUE, out.width="100%", cache=TRUE, echo=FALSE, fig.cap = "error-correcting system"}
knitr::include_graphics("./assets/error_correction.png")
```
```{marginfigure}
\vspace*{-15px}\noindent
Source: [error_correction.png]() at .
```
...
\begin{margintable}%
  ...
  \begin{tabular}{l}
    ...
    \bottomrule
  \end{tabular}
  \caption{Lyapunov functions can be used for a wide variety of problems, way beyond stability. Source: \href{https://stanford.edu/~boyd/papers/pdf/springer_15_colloquium.pdf}{120 Years of Lyapunov’s Methods} at *stanford.edu*.}
  \label{tab:lyapunov}
\end{margintable}
...
\href{https://pni.princeton.edu/sites/default/files/basic-page/files/John Hopfield Now What 3_0.pdf}{Link to article in PDF}}
