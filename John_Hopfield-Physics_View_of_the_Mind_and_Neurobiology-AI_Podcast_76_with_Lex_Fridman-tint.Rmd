...
So, you expect in [neurobiology](https://mbb.harvard.edu/pages/undergraduate-tracks-neurobiology) for evolution to have captured all kinds of possibilities of getting neurons ... how you get neurons to do things for you. And that aspect has been completely suppressed in artificial neural networks. 
...
```{r fig.margin = TRUE, out.width="100%", cache=TRUE, echo=FALSE, fig.cap = "Viscous passive dampers were installed at several locations at The Millenium Bridge in London to limit dynamic excitation by pedestrians walking in synchronization with the bridge movement."}
...
```{r fig.margin = TRUE, out.width="100%", cache=TRUE, echo=FALSE, fig.cap = "Action potential, the brief (about one-thousandth of a second) reversal of electric polarization of the membrane of a nerve cell (neuron) or muscle cell."}
...
```{r fig.margin = TRUE, out.width="120%", cache=TRUE, echo=FALSE, fig.cap = "Layered cortex and interconnections."}
...
```{r fig.margin = TRUE, out.width="100%", cache=TRUE, echo=FALSE, fig.cap = "Cortex to spinal cord."}
...
And now let me leave you with some words of wisdom from John Hopfield in his article titled *Now What*^[Article published in October 2008. | [Link to article at princeton.edu](https://pni.princeton.edu/john-hopfield/john-j.-hopfield-now-what). |  [Link to article in PDF](https://pni.princeton.edu/sites/default/files/basic-page/files/John%20Hopfield%20Now%20What%203_0.pdf)]
